...
export default function ReceiptClientLinkManager() {
  ...
  useEffect(() => {
    const sync = () => {
      ...
      setIsReceipts(title === "recebimentos");
    };
    sync();
